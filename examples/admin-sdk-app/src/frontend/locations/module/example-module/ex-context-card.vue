...
import { context, notification } from '@cicada-ag/meteor-admin-sdk';
import { SwCard, SwButton } from '@cicada-ag/meteor-component-library';
...
async function getCurrentShopwareVersion() {
  const currentShopwareVersion = await context.getCicadaVersion();
